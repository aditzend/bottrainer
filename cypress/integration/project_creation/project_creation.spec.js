...
describe('Project Creation', function() {
    ...
    it('Al crear un nuevo proyecto, un modelo por defecto debe agregarse al proyecto ', function() {
        ...
        cy.contains('Seleccione el idioma por defecto del proyecto').click();
