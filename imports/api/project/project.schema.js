...
export const chatWidgetSettingsSchema = new SimpleSchema(
    {
        ...
        customData: SimpleSchema.oneOf(
            { type: String, optional: true, custom: validateJSON },
...
export const ProjectsSchema = new SimpleSchema(
    {
        ...
        namespace: {
            ...
            sparse: 1,
            custom() {
                return !this.value.match(/^[a-zA-Z0-9-]+$/) ? 'invalidNamespace' : null;
...
ProjectsSchema.messageBox.messages({
    en: {
        ...
        invalidNamespace:
            'El Stack solo puede contener caracteres alfanuméricos y guiones.',
    },
});
