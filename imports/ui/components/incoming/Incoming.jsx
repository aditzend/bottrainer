...
export default function Incoming(props) {
    ...
    const renderTabs = () => (
        [
            { value: 'newutterances', text: 'Nuevas Uteraciones' },
            { value: 'conversations', text: 'Conversaciones' },
            { value: 'forms', text: 'Resultados de Formularios' },
            { value: 'populate', text: 'Llenar' },
        ].map(({ value, text }) => (
            <Menu.Item
                content={text}
                key={value}
