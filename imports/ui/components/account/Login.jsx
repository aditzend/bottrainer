                ...
                {loggedOut && (
                    <Segment className='account-block'>
                        <AutoForm model={{}} schema={this.loginFormSchemaBridge} onSubmit={this.handleLogin} className='ui large account-form' disabled={loggingIn}>
                            ...
                            <TextField name='password' iconLeft='lock' placeholder='Contraseña' type='password' label={null} data-cy='password-field' />
                            {reCatpchaSiteKey && (
                                <div>
                            ...
                            <SubmitField value='ENTRAR' className='black large basic fluid' disabled={reCatpchaSiteKey && !reCaptcha} data-cy='login-button' />
                            <br />
