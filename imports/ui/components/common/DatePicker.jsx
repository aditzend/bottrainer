        ...
        <Popup
            ...
            trigger={(
                <Button icon labelPosition='left' onClick={() => handlePopupState()} className='date-picker-button'>
                    {startDate ? getDateString(startDate, endDate, 'DD/MM/YYYY') : placeholder || 'Elija un rango'}
                            ...
                            {onConfirmForAll && (
                                <Dropdown
                                    ...
                                    options={[{
                                        ...
                                        text: 'Aplicar a todas las tarjetas',
