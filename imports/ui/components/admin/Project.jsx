...
class Project extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <PageMenu icon='sitemap' title={project._id ? project.name : 'Nuevo proyecto'} />
                <Container>
                    {!loading && (
                        <Segment>
                            <AutoForm
                                ...
                                model={project}
                            >
                                <AutoField name='name' label='Descripción' data-cy='project-name' />
                                <InfoField
                                    name='namespace'
                                    label='Stack'
                                    ...
                                    disabled={!!namespace}
                                />
                                <SelectField name='defaultLanguage' label={null} placeholder='Seleccione el idioma por defecto del proyecto' />
                                <br />
                               
                                <AutoField name='disabled' label='Desactivado' data-cy='disable' />
                                <ErrorsField />
                                <SubmitField label='Crear' data-cy='submit-field' />
                            </AutoForm>
                        </Segment>
                    )}
                    {!loading && project._id && (
                        <Can I='global-admin'>
                            <Segment>
                                <Header content='Eliminar proyecto' />
                                {!project.disabled && <Message info content='Un proyecto debe estar desactivado antes de poder borrarlo' />}
                                <br />
                                ...
                                <Confirm
                                    open={confirmOpen}
                                    header={`Eliminar proyecto ${project.name}?`}
