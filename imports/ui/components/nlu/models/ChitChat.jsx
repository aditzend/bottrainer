                ...
                {chitChatIntents && chitChatIntents.length > 0 && (
                    <div className='chitchat' style={{ minHeight: 300 }}>
                        ...
                        <Dropdown
                            ...
                            placeholder='Selecciona intenciones tipo chit-chat'
                            multiple
                            selection
                            fluid
                        ...
                        <Button
                            ...
                            content='Agregar a data de entrenamiento'
                            onClick={this.open}
                            data-cy='add-chit-chat'
                        />
                        <Confirm
                            header='¿Agregar a data de entrenamiento?'
                            content={`Estás seguro de que deseas agregar ${selectedIntents.join(' ')} intents a la data de entrenamiento?`}
                            open={confirmOpen}
                            onCancel={this.close}
