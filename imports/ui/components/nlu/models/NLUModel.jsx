...
function NLUModel(props) {
            ...
            return (
                <Message
                    ...
                    content={(
                        <div>
                            <Icon name='warning' />
                            Necesita al menos dos intenciones para entrenar el modelo.
                        </div>
                    )}
                    info
                />
    ...
    const topMenuItems = [
        ['Data de Entrenamiento', 'database', true],
        ['Testing', 'percent', can('nlu-data:x', projectId)],
        ['Estadísticas', 'pie graph', true],
        ['Configuración', 'setting', true],
    ];
    ...
    return (
        <>
            ...
            <Container data-cy='nlu-page'>
                {['Data de Entrenamiento', 'Testing'].includes(activeItem) && (
                    <>
                ...
                <br />
                {activeItem === 'Data de Entrenamiento' && (
                    <Tab
