        ...
        return (
            <Tab.Pane>
                <AutoForm schema={new SimpleSchema2Bridge(new SimpleSchema(this.schema))} model={this.sparseModel()} onSubmit={this.handleSave}>
                    ...
                    <AutoField name='hasNoWhitespace' label='Activar modo de lenguaje sin espacios en blanco' data-cy='whitespace-option' />
                    ...
                    {showConfirmation && (
                        <ChangesSaved
                            ...
                            content={(
                                <p>
                                    Necesita <b>re-entrenar</b> su modelo para desplegarlos
