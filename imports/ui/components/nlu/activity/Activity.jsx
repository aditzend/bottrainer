            ...
            <Can I='nlu-data:w'>
                <Button.Group>
                    <Button
                        ...
                        onClick={() => setConfirm({
                            message:
                                'Esto evaluará el modelo usando ejemplos validados como conjunto de validación y sobreescribirá las evaluaciones actuales.',
                            action: linkRender,
                        })
                        }
                    ...
                    <Button
                        ...
                        onClick={() => setConfirm({
                            message:
                                'Las uteraciones validadas serán añadidas a la base de datos de entrenamiento.',
                    ...
                    >
                        ...
                        Agregar a data  de entrenamiento
                    </Button>
                </Button.Group>
            </Can>
            <PrefixDropdown
                ...
                options={[
                    { value: 'Newest', text: 'Más nuevo' },
                    { value: 'Oldest', text: 'Más viejo' },
                    { value: 'Validated first', text: 'Validado primero' },
                    { value: 'Validated last', text: 'Validado último' },
        ...
        <>
            ...
            {data && data.length ? (
                ...
                <Message
                    ...
                    data-cy='no-activity'
                    content='No hay actividad para mostrar'
                />
            )}
        </>
    );
